...
export default function Documentation3() {
    return(
        ...
        <div className={styles.footer}>
            ...
            <ul>
            <li><Link href="/documentation2"><img className={styles.img} src="https://cdn-icons-png.flaticon.com/128/1053/1053188.png"></img></Link>Back</li>
                <li>3/12</li>
                <li>Next<Link href="/documentation4"><img className={styles.img} src="https://cdn-icons-png.flaticon.com/128/1053/1053190.png"></img></Link></li>
            </ul>
        </div>
        </div>
    )
