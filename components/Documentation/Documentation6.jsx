...
export default function Documentation6() {
    return(
        ...
        <div className={styles.footer}>
            ...
            <ul>
            <li><Link href="/documentation5"><img className={styles.img} src="https://cdn-icons-png.flaticon.com/128/1053/1053188.png"></img></Link>Back</li>
                <li>6/12</li>
                <li>Next<Link href="/documentation7"><img className={styles.img} src="https://cdn-icons-png.flaticon.com/128/1053/1053190.png"></img></Link></li>
            </ul>
        </div>
        </div>
    )
