...
export default function Documentation9() {
    return(
        ...
        <div className={styles.footer}>
            ...
            <ul>
            <li><Link href="/documentation8"><img className={styles.img} src="https://cdn-icons-png.flaticon.com/128/1053/1053188.png"></img></Link>Back</li>
                <li>9/12</li>
                <li>Next<Link href="/documentation10"><img className={styles.img} src="https://cdn-icons-png.flaticon.com/128/1053/1053190.png"></img></Link></li>
            </ul>
        </div>
        </div>
    )
