...
export default function Documentation12() {
    return(
        ...
        <div className={styles.footer}>
            ...
            <ul>
                <li><Link href="/documentation11"><img className={styles.img} src="https://cdn-icons-png.flaticon.com/128/1053/1053188.png"></img></Link>Back</li>
                <li>12/12</li>
                <li>Next<img className={styles.img} src="https://cdn-icons-png.flaticon.com/128/1053/1053190.png"></img></li>
            </ul>
        </div>
        </div>
    )
