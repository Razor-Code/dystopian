    ...
    return (
      ...
      <div className={styles.container}>
        <div className={styles.docs}>
          <h1>Python Programming Language </h1>
            ...
            <ol className={styles.list}>
              ...
              <li>
                ...
                and indentation requirement of the language, makes them readable
                all the time.
              </li>
              <li>
          ...
          <div className={styles.compilerCont}>
            <iframe
              className={styles.compiler}
              src="https://trinket.io/embed/python/9f5f0b7d5e"
              width="100%"
              height="600"
              frameborder="0"
              marginwidth="0"
        ...
        <div className={styles.footer}>
          <h2>
            <img
              ...
              src="https://cdn-icons.flaticon.com/png/128/3246/premium/3246112.png?token=exp=1659959388~hmac=10eab2dfb5b2871ef8aea9744130da6b"
            ></img>{" "}
            Introduction
          </h2>
          <ul>
            <li>
              <img
                className={styles.img}
                src="https://cdn-icons-png.flaticon.com/128/1053/1053188.png"
              ></img>
              Back
            </li>
            <li>0/12</li>
            <li>
              Next
              <Link href="/documentation1">
                <img
                  className={styles.img}
                  src="https://cdn-icons-png.flaticon.com/128/1053/1053190.png"
                ></img>
              </Link>
            </li>
          </ul>
