...
export default function Documentation5() {
    return(
        ...
        <div className={styles.footer}>
            ...
            <ul>
            <li><Link href="/documentation4"><img className={styles.img} src="https://cdn-icons-png.flaticon.com/128/1053/1053188.png"></img></Link>Back</li>
                <li>5/12</li>
                <li>Next<Link href="/documentation6"><img className={styles.img} src="https://cdn-icons-png.flaticon.com/128/1053/1053190.png"></img></Link></li>
            </ul>
        </div>
        </div>
    )
